...
$search_namespace = "Grant HD052120"; // A short, human-readable name for the output subfolder directly related to this search
...
//
    ...
    $db_filename = __DIR__ . "/databaseTest.sqlite";
...
print "Processed {$iid}! <a href=\"/pmc_grabber/output/{$search_namespace}/{$iid}.xml\">View XML</a>";
print "<br>";
}
}
